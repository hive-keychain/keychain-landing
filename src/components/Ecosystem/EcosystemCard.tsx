...
const EcosystemCard: React.FC<EcosystemCardProps> = ({ name, description, icon, url }) => (
  <AnimatedSection direction="up" className="group">
    <a 
      ...
      className="block p-4 bg-white rounded-xl shadow-md hover:shadow-xl transition-all transform hover:-translate-y-1 h-full flex flex-col justify-between min-h-[250px]" // Establecemos una altura mínima consistente
    >

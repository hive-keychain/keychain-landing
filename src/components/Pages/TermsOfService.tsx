    ...
    <div className="min-h-screen bg-white pt-20 pb-12">
      <div className="container mx-auto px-4">
        ...
        <div className="prose max-w-none px-60">
          ...
          <p className="text-gray-700 mb-4">
            Please read these Terms carefully before using the Site or Services. By accessing this Site, or using our Services and/or Content (defined below) in any manner, you (i) accept and agree to these Terms and (ii) consent to the collection, use, disclosure and other handling of information as described in our Privacy Policy, available here (the "Privacy Policy"). The Privacy Policy is incorporated herein by this reference in its entirety, and all references herein to the "Terms of Service", the "Terms" or this "Agreement", include a reference to the Privacy Policy.
          </p>

          <h3 className="text-lg font-semibold mt-6 mb-2">2. Terms of Services</h3>
          <h4 className="text-md font-semibold mt-4 mb-2">2.1 Changes to Terms of Services</h4>
          <p className="text-gray-700 mb-4">
            We may decide to make changes to this Agreement, in which case we will provide notice of those changes by updating the "Last Updated" date above, posting a notice via our blog. Your continued use of the Service will confirm your acceptance of the changes.
          </p>
          <p className="text-gray-700 mb-4">
          ...
          <h4 className="text-md font-semibold mt-4 mb-2">2.2 Third-Party Services</h4>
          <p className="text-gray-700 mb-4">
            When you use our Site and/or Services, you may also be using the services of one or more third parties. For example, our feed prices come from Coingecko, our Extensions can be obtained by the Chrome Store and Firefox Add-Ons Store, and our Mobile Apps by the Play Store and Apple Store. Your use of those and other third-party services ("Third-Party Services") will be subject to the privacy policies, terms of use and similar policies and terms, and fees of those third party services.
          </p>

          <h3 className="text-lg font-semibold mt-6 mb-2">3. Eligibility</h3>
          <p className="text-gray-700 mb-4">
            You may use the Services if you are considered of age in your jurisdiction of residence, or older, and are not forbidden from using the Services under the applicable law. By using the Site or Services and agreeing to these Terms, you represent and warrant that:
          </p>
          ...
          <h3 className="text-lg font-semibold mt-6 mb-2">6. Content Ownership</h3>
          <p className="text-gray-700 mb-4">
          ...
          <h3 className="text-lg font-semibold mt-6 mb-2">6.1 Rights in User Content Granted by You</h3>
          <p className="text-gray-700 mb-4">
          ...
          <h3 className="text-lg font-semibold mt-6 mb-2">6.2 Rights in Extensions, Mobile Apps, Site and Services Granted by Hive Keychain</h3>
          <p className="text-gray-700 mb-4">
          ...
          <p className="text-gray-700 mb-4">
            We may charge fees for some or part of the Services provided to you, including fees charged on token swaps that you execute on third-party exchanges. We reserve the right to change those fees at any time, in our sole and absolute discretion. We will disclose the amount of fees we will charge you for the applicable Service at the time that you access the Service. You may view the fees currently charged for our Services <a href="https://hive-keychain.com/#/fees" className='text-red-700'>here</a>.
          </p>
          <p className="text-gray-700 mb-4">
          ...
          <p className="text-gray-700 mb-4">
            8.2 Avoid, bypass, remove, deactivate, impair, descramble or otherwise circumvent any technological measure implemented by us or any of our service providers or any other third party to protect the Services or Content;          </p>
          <p className="text-gray-700 mb-4">
            8.3 Interfere with, or attempt to interfere with, the access to the Services of any user, host or network, including, without limitation, sending a virus, overloading, flooding, spamming, or mail-bombing the Services;          </p>
          <p className="text-gray-700 mb-4">
          ...
          <p className="text-gray-700 mb-4">
            Any Digital Assets you transfer via the Services have been legally obtained by, and belong to, you; You will not provide any false, inaccurate or misleading information while using the Site or Services, or engage in any activity that operates to defraud Hive Keychain, other users of the Services, or any other person or entity; You will not use the Services to transmit or exchange Digital Assets that are the direct or indirect proceeds of any criminal or fraudulent activity, including, without limitation, terrorism or tax evasion; Any Digital Assets you use in connection with the Services are either owned by you or you are validly authorized to carry out actions using such assets.
          </p>
          <p className="text-gray-700 mb-4">
          ...
          <h3 className="text-lg font-semibold mt-6 mb-2">9. Third Party Services</h3>
          <p className="text-gray-700 mb-4">
          ...
          <p className="text-gray-700 mb-4">
            By using this Service, you acknowledge that (i) the use of the Swap feature may incure fees, as disclosed in the <a href="https://hive-keychain.com/#/fees" className='text-red-700'>fees page</a> and/or while using the Service, (ii) the output token amount is an estimation and as such is subject to change following market changes, (iii) some swaps necessitate several steps, and as such, if the slippage is reached during an intermediate stage, this intermediate token will be returned to you, (iv) there is no slippage protection on the Hive-Engine market, the Swap Service will cancel the Swap if a new estimation reaches the slippage, but there is no guarantee that the slippage won't be exceeded due to a sudden market change, (v) third-party providers fees are subject to changes unbeknownst of Hive Keychain and (vi) the Swap Service is relying on both Hive and Hive-Engine RPC Nodes to keep its data up-to-date and as such, can experience downtime. Hive Keychain should not be liable for any losses caused by the unability to access the Service.
          </p>

          <h3 className="text-lg font-semibold mt-6 mb-2">11. Warranty Disclaimers</h3>
          <p className="text-gray-700 mb-4">
          ...
          <h3 className="text-lg font-semibold mt-6 mb-2">12. No Professional Advice or Fiduciary Duties</h3>
          <p className="text-gray-700 mb-4">
          ...
          <h3 className="text-lg font-semibold mt-6 mb-2">14. Limitation of Liability</h3>
          <p className="text-gray-700 mb-4">
          ...
          <h3 className="text-lg font-semibold mt-6 mb-2">15. Risks Disclaimer</h3>
          <p className="text-gray-700 mb-4">
          ...
          <h3 className="text-lg font-semibold mt-6 mb-2">16. Contact Information</h3>
          <p className="text-gray-700 mb-4">
            If you have any questions about these Terms or the Services, please contact us at <a href="mailto:stoodkev@hive-keychain.com" className='text-red-700'>stoodkev@hive-keychain.com</a>.
          </p>
